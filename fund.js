...
//2. Calculate the Results and Validate Data

//3. Process the Data into the Format

//4. **RETURN** the results

// note to self -- delete console.log test outputs and ensure return is present.
console.log(averageScore);

//---------------Program Resources----------------

// to calculate total score
let assigment1Score = averageScore(LearnerSubmissions[0].submission.score);
let assignment2Score = averageScore(LearnerSubmissions[0].submission.score);
...
function totalScore() {
  let total = (assigment1Score + assignment2Score) / 2;
  return total;
}
...
function assignmentOnTime(submitDate, dueDate) {
  if (submitDate !== dueDate) {
    ...
    let timeDifference =
      (dateSubmitted.getTime() - dateDue.getTime()) / (1000 * 3600 * 24);
